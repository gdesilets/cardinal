...
- Strategy match (if applicable): note if this matches one of the corpus strategies
  (`query_corpus.py strategies`) and cite its `strategy-report` win/loss n if relevant.
