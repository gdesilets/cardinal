...
SOURCE = ROOT / "postpromotion_generic_qa.json"
TARGET = ROOT / "postpromotion_generic_qa_gate.json"
...
result = {
    ...
    "interpretation": (
        "All post-promotion artifact-specific generic QA checks passed; the only "
        "failures are expected full-release infrastructure omissions in a one-file "
        "isolated audit."
    ),
