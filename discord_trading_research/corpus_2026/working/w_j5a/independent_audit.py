...
EXPECTED_SHA256 = "b9c097693c80aa51bb5b0ce3a43767b20a55db1a0b657df171db00d0c4f4c5bd"
...
# Jan. 5, 2026 is unambiguously Central Standard Time (UTC-06:00).
...
all_error_counts = {
    ...
    "message_count_mismatch": int(len(messages) != 430),
    ...
    "noncontiguous_result_indices": int(indices != list(range(1, 431))),
    "unexpected_page_distribution": int(
        collections.Counter(pages)
        != collections.Counter({**{page: 25 for page in range(1, 18)}, 18: 5})
    ),
